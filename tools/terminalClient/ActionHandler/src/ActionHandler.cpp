...
//             Response room = controller.createRoom(data, sender);

//             if(room.status == Status::SUCCESS){
//                 //return room code to client
//                 return createaJSONMessage("Game Created", room.message);
//             }
//             else{
//                 return createaJSONMessage("Error", "Failed to create room");
//             }
